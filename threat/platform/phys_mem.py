#!/usr/bin/env python
"""
Created on Wednesday, January 19, 2022 at 11:26:53 by 'Wesley Cobb <wesley@bpcs.com>'
Copyright (C) 2022, by Blueprint Technologies. All Rights Reserved.
 
Last edited: <2022-01-19 11:26:56 wcobb>
...
def phys_mem(output_root="/dev/shm", output_file="phys_mem.txt", verbose=False):
    '''
    Physical Memory of this System in Gigabytes
            ...
            with open(output_path, "r") as ofile:
                ...
                for line in lines:
                    if ("Mem:" in line):
                        ...
                        parts = line.split(" ")
                        phys_mem = 4*int((int(parts[1]) + 2048)/4096)
